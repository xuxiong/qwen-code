  ...
  security: {
    ...
    properties: {
      ...
      custom: {
        ...
        description: 'Settings for custom OAuth 2.0 provider.',
        showInDialog: false,
        properties: {
          apiUrl: {
            type: 'string',
            ...
            category: 'Security',
            requiresRestart: false,
            default: 'https://your-llm-api.com/v1',
            description: 'The base URL for the custom LLM API.',
            showInDialog: true,
          },
          authServerUrl: {
            type: 'string',
            ...
            category: 'Security',
            requiresRestart: false,
            default: 'https://your-oauth-server.com',
            description:
              'The base URL for the OAuth 2.0 authentication server.',
            showInDialog: true,
          },
          clientId: {
            type: 'string',
            ...
            description: 'The OAuth 2.0 Client ID for device flow.',
            showInDialog: true,
          },
          scope: {
            type: 'string',
            ...
            category: 'Security',
            requiresRestart: false,
            default: 'openid profile model.completion',
            description: 'The OAuth scopes to request.',
            showInDialog: true,
          },
          staticApiKey: {
            type: 'string',
            label: 'Static API Key (for testing without OAuth)',
            category: 'Security',
            requiresRestart: false,
            default: '',
            description:
              'A static API key to bypass OAuth for testing purposes. Leave empty for OAuth.',
            showInDialog: true,
          },
          models: {
            type: 'array',
            ...
            default: [
              {
                id: 'default-model-id',
                label: 'Default Model',
                description: 'Default model for this service.',
              },
            ] as CustomModelDefinition[],
            description: 'List of available models for this custom service.',
            showInDialog: false,
          },
        },
      },
